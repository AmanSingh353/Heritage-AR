...
const sites = [
  ...
  { name: "Jagannath Temple", era: "12th century CE", img: jagannath, desc: "One of the Char Dham — a living temple of devotion in Puri.",location: "Puri, Odisha, India", origin: "12th Century CE", builtBy: "King Anantavarman Chodaganga Deva (Eastern Ganga Dynasty)", fullDesc: "Jagannath Temple is one of India's most sacred Hindu temples, dedicated to Lord Jagannath, Lord Balabhadra, and Goddess Subhadra. Built in the 12th century CE, it is a masterpiece of Kalinga architecture and the spiritual heart of Odisha. The temple is world-famous for its annual 'Rath Yatra', which attracts millions of devotees and visitors from around the world." },
  { name: "Konark Sun Temple", era: "13th century CE", img: konark, desc: "A monumental chariot for the sun god, a UNESCO World Heritage Site.", location: "Konark, Puri District, Odisha, India", origin: "13th Century CE", builtBy: "King Narasimhadeva I (Eastern Ganga Dynasty)", fullDesc: "Konark Sun Temple is a magnificent 13th-century temple dedicated to the Sun God, Surya. Designed in the shape of a colossal stone chariot with intricately carved wheels and horses, it represents the pinnacle of Kalinga architecture. A UNESCO World Heritage Site, the temple is celebrated for its artistic excellence, engineering brilliance, and rich cultural significan" },
